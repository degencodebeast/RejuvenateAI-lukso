...
bytes32 constant _CN_MEAL_PLANS_ARRAY_KEY = 0x8a82c15a8cea01b6a5d0db3b14e480dfe3197f0aa048e916d77b79abcc7a697c; // keccak256('SNSubscribers[]')
bytes12 constant _CN_MEAL_PLANS_MAP_KEY = 0x90f039af6118e0ccbbd00000; // bytes10(keccak256('SNSubscribers')) + bytes2(0)
...
bytes32 constant _CN_FITNESS_PLANS_ARRAY_KEY = 0xafd89daf17abdaf5797bc0e7d4dbdc56a217d1b6e08b426b40b8f99b9a03fc6c; // keccak256('SNUserTags[]')
bytes12 constant _CN_FITNESS_PLANS_MAP_KEY = 0x6737a26dc0027d9a47570000; // bytes10(keccak256('SNUserTags')) + bytes2(0)
...
bytes32 constant _CN_ARTICLES_ARRAY_KEY = 0xe01ddb6ad4391dac642308cf420c56ac6a269002a7475dafeee62ea09be7a114; // keccak256('SNPosts[]')
bytes12 constant _CN_ARTICLES_MAP_KEY = 0x7e8492281728d34c260d0000; // bytes10(keccak256('SNPosts')) + bytes2(0)