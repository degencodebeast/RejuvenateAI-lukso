...
interface INutritionistProfileData is IERC165, IERC725Y {
    ...
    function getNumberOfMealPlans() external;
    ...
    function getNumberOfFitnessPlans() external;
    ...
    function getNumberOfConsultations() external;
    ...
    function getNumberOfArticles() external;
